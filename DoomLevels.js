...
function drawNewEnemies1() {
    GameInfo.enemyArray.push(new Troop(30, new Position(0, 30, 0.6), [new AnimationInfo("topTo_60", '3s'), new AnimationInfo("scaleTo_1", '3s'), new AnimationInfo("leftTo_10", '2s')]), new Troop(20, new Position(20, 37)), new Troop(20, new Position(30, 60)), new ShotGun_Troop(30, new Position(50, 55)), new ShotGun_Troop(30, new Position(70, 30), [new AnimationInfo("scaleTo_1", '4s', '1')]), new Extra("TroopLeft" + "_Tomer", 10, new Position(100, 30, 0.6), [new AnimationInfo("fleeLeft", '7s', '1')]));
}
