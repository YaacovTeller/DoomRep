...
function drawNewEnemies1() {
    GameInfo.enemyArray.push(new Troop(30, new Position(10, 60), new AnimationInfo("move", '7s')), new Troop(20, new Position(20, 37)), new Troop(20, new Position(30, 60)), new ShotGun_Troop(30, new Position(50, 55)), new ShotGun_Troop(30, new Position(70, 30), new AnimationInfo("approach", '8s', '', 'alternate')), new Extra("TroopLeft" + "_Tomer", 10, new Position(70, 30, 0.6), new AnimationInfo("flee", '7s', '1')));
}
...
function drawNewEnemies3() {
    GameInfo.enemyArray.push(new Imp(30, new Position(10, 40), new AnimationInfo("move8", '4s')), new Imp(30, new Position(50, 40), new AnimationInfo("move9", '3s')), new Imp(30, new Position(40, 45)), new Imp(30, new Position(25, 55)), new Imp(30, new Position(16, 48), new AnimationInfo("move12", '4s')));
}
