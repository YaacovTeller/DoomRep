...
function drawNewEnemies_2_1() {
    ...
    new Troop(new Position(20, 37)), new Troop(new Position(30, 60)), new ShotgunTroop(new Position(50, 55)), new ShotgunTroop(new Position(70, 30), null, [new AnimationInfo("scaleTo_1", '4s', '1')]), 
...
function drawNewEnemies_2_2() {
    GameInfo.enemyArray.push(new Troop(new Position(30, 50)), new ShotgunTroop(new Position(40, 45)), new ShotgunTroop(new Position(60, 55)), new Troop(new Position(85, 65)), new Troop(new Position(75, 35)));
    LevelHandler.startAllRolls(GameInfo.moverollFrequency, hitLimit.slow);
}
...
function drawNewEnemies_2_4() {
    ...
    new ShotgunTroop(new Position(40, 48, 0.3)), new Troop(new Position(46, 48, 0.3)), new ShotgunTroop(new Position(7, 55, 1)), new Troop(new Position(18, 60, 1.2)), new Troop(new Position(50, 53, 0.5)), new ShotgunTroop(new Position(60, 53, 0.5)), new Troop(new Position(68, 53, 0.5)));
    t1.noRandomMovement = true;
    t2.noRandomMovement = true;
    LevelHandler.startAllRolls(GameInfo.moverollFrequency, hitLimit.slow);
}
function drawNewEnemies_2_5() {
    GameInfo.enemyArray.push(new Troop(new Position(5, 45)), new Troop(new Position(15, 50)), new Imp(new Position(20, 60)), new ShotgunTroop(new Position(47, 27, 0.4)), new ShotgunTroop(new Position(80, 27, 0.4)), new ShotgunTroop(new Position(65, 45)), new Troop(new Position(60, 50)), new Troop(new Position(70, 30, 0.5)), new Imp(new Position(70, 45)), new Troop(new Position(85, 58)), new ShotgunTroop(new Position(15, 18, 0.1), 15, [], specialEnemy.Extra));
    LevelHandler.startAllRolls(GameInfo.moverollFrequency, hitLimit.slow);
}
function drawNewEnemies_2_6() {
    GameInfo.bossTotalHealth = 350;
    GameInfo.enemyArray.push(new ChaingunGuy(new Position(40, 35, 0.8), GameInfo.bossTotalHealth, [new AnimationInfo("scaleTo_1p8", '7s', 1)], specialEnemy.Boss));
    LevelHandler.startAllRolls(GameInfo.moverollFrequency, hitLimit.fast);
    resetBossBar();
}
function drawNewEnemies_3_1() {
    GameInfo.enemyArray.push(new ChaingunGuy(new Position(5, 45)), new ShotgunTroop(new Position(47, 27, 0.4)), new ShotgunTroop(new Position(60, 50)), new ShotgunTroop(new Position(65, 45)), new Troop(new Position(70, 30, 0.5)), new Troop(new Position(70, 45)), new ShotgunTroop(new Position(80, 30, 0.3), 15, [], specialEnemy.Extra));
    LevelHandler.startAllRolls(GameInfo.moverollFrequency, hitLimit.slow);
}
function drawNewEnemies_3_2() {
    GameInfo.enemyArray.push(new ChaingunGuy(new Position(5, 45)), new ChaingunGuy(new Position(47, 27, 0.4)), new ChaingunGuy(new Position(60, 50)), new ChaingunGuy(new Position(65, 45)));
    LevelHandler.startAllRolls(GameInfo.moverollFrequency, hitLimit.slow);
}
function drawNewEnemies_3_3() {
    GameInfo.enemyArray.push(new Imp(new Position(5, 45)), new ChaingunGuy(new Position(47, 27, 0.4)), new Imp(new Position(60, 50)), new Imp(new Position(65, 45)), new Imp(new Position(50, 50)), new Imp(new Position(45, 45)));
    LevelHandler.startAllRolls(GameInfo.moverollFrequency, hitLimit.slow);
}
...
function drawNewEnemies_3_5() {
    GameInfo.enemyArray.push(new Troop(new Position(5, 45)), new Troop(new Position(47, 27, 0.4)), new ShotgunTroop(new Position(60, 50)), new ShotgunTroop(new Position(65, 45)), new ShotgunTroop(new Position(50, 50)), new Troop(new Position(45, 45)), new Troop(new Position(50, 50)), new Troop(new Position(45, 45)));
    LevelHandler.startAllRolls(GameInfo.moverollFrequency, hitLimit.Xfast);
}
function drawNewEnemies_3_6() {
    GameInfo.enemyArray.push(new ChaingunGuy(new Position(5, 45)), new ChaingunGuy(new Position(47, 27)), new ChaingunGuy(new Position(60, 50)), new ChaingunGuy(new Position(65, 45)), new ChaingunGuy(new Position(50, 50)), new ChaingunGuy(new Position(45, 45)));
    GameInfo.itemArray.push(new Item("barrel", new Position(52, 25), 40));
    LevelHandler.startAllRolls(GameInfo.moverollFrequency, hitLimit.slow);
}
function drawNewEnemies_3_7() {
    GameInfo.bossTotalHealth = 450;
    GameInfo.enemyArray.push(new ChaingunGuy(GameInfo.bossTotalHealth, new Position(40, 35, 0.8), [new AnimationInfo("scaleTo_1p8", '7s', 1)], specialEnemy.Boss));
    LevelHandler.startAllRolls(GameInfo.moverollFrequency, hitLimit.fast);
    resetBossBar();
}
