...
var BSMenu = new sound("sound/Music/BS/03_Meeting.mp3");
var AliensOfGold = new sound("sound/Music/BS/02_Aliens_of_Gold.mp3");
var DarkHall = new sound("sound/Music/BS/06_Dark_Hall.mp3");
var Jungle = new sound("sound/Music/BS/07_Jungle.mp3");
var RacShuffle = new sound("sound/Music/BS/08_Rac_Shuffle.mp3");
var BlakeMusic = [AliensOfGold, DarkHall, Jungle, RacShuffle];
var Intermission = new sound("sound/Music/DOOM/113_Intermission_From_DOOM.mp3");
var DoomsGate = new sound("sound/Music/DOOM/102_At_Doom's_Gate.mp3");
var Secrets = new sound("sound/Music/DOOM/110_Hiding_the_Secrets.mp3");
//var Demons = new sound("sound/Music/DOOM/112_The_Demons_From_Adrian's_Pen.mp3") // slow start
var Untitled = new sound("sound/Music/DOOM/118_Untitled.mp3");
var Donna = new sound("sound/Music/DOOM/119_Donna_to_the_Rescue.mp3");
var Spider = new sound("sound/Music/DOOM/121_Facing_the_Spider.mp3");
