...
const enemyPics = {
    ...
    TroopLeft: "assets/enemies/GIMP gifs/Troop_left_g.gif",
    TroopLeft_Tomer: "assets/enemies/TroopLeft_Tomer.gif",
    left: {
        Troop: "assets/enemies/GIMP gifs/Troop_left_g.gif",
        ShotGun_Troop: "assets/enemies/GIMP gifs/SGunGuy_left.gif",
        ChainGuy: "assets/enemies/GIMP gifs/chain_left.gif",
        Imp: "assets/enemies/GIMP gifs/Imp_left.gif",
    },
    right: {
        Troop: "assets/enemies/GIMP gifs/Troop_right_g.gif",
        ShotGun_Troop: "assets/enemies/GIMP gifs/SGunGuy_right.gif",
        ChainGuy: "assets/enemies/GIMP gifs/chain_right.gif",
        Imp: "assets/enemies/GIMP gifs/Imp_right.gif",
    },
    hurt: {
