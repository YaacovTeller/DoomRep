...
function drawNewEnemies1(){
    ...
    RegEnemy.enemyArray.push(
        ...
        new ShotGGuy(30, new Position(50,55)),
        new ShotGGuy(30, new Position(70,30), new AnimationInfo("approach",'8s','','alternate')),
...
function drawNewEnemies2(){
    ...
    RegEnemy.enemyArray.push(
        ...
        new ShotGGuy(30, new Position(40,45)),
        new ShotGGuy(30, new Position(60,55)),
...
function drawNewEnemies4(){
   ...
   RegEnemy.enemyArray.push(
        ...
        new ShotGGuy(30, new Position(40,48, 0.3)),
        new Troop   (10, new Position(46,48, 0.3)),
        new ShotGGuy(30, new Position(7,55, 1)),
        new Troop   (10, new Position(18,60, 1.2)),
        new Troop   (10, new Position(50,53, 0.5)),
        new ShotGGuy(30, new Position(60,53, 0.5)),
...
function drawNewEnemies5(){
   ...
   RegEnemy.enemyArray.push(
        ...
        new ShotGGuy(30, new Position(47,27,0.4)),
        new Troop   (10, new Position(60,50)),
        new ShotGGuy(30, new Position(65,45)),
        new Troop   (10, new Position(70,30,0.5)),
        new Imp     (30, new Position(70,45)),
        new ShotGGuy(30, new Position(80,27,0.4)),
        new Troop   (10, new Position(85,58)),
        new Extra("ShotGGuy", 10, new Position(15,18,0.1))
    )
}
